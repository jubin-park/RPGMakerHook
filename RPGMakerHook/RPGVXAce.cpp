...
namespace RPGVXAce
{
    CommandInfo gCommands[] =
    {
        ...
        // CUSTOM Scripts
        {
            ...
            0x4C766D,
            "if !defined?(rpgvxace_save_without_scripts);def rpgvxace_save_without_scripts;$data_scripts = nil;save_data($data_actors, 'Data/Actors.rvdata2');save_data($data_classes, 'Data/Classes.rvdata2');save_data($data_skills, 'Data/Skills.rvdata2');save_data($data_items, 'Data/Items.rvdata2');save_data($data_weapons, 'Data/Weapons.rvdata2');save_data($data_armors, 'Data/Armors.rvdata2');save_data($data_enemies, 'Data/Enemies.rvdata2');save_data($data_troops, 'Data/Troops.rvdata2');save_data($data_states, 'Data/States.rvdata2');save_data($data_animations, 'Data/Animations.rvdata2');save_data($data_tilesets, 'Data/Tilesets.rvdata2');save_data($data_common_events, 'Data/CommonEvents.rvdata2');save_data($data_system, 'Data/System.rvdata2');save_data($data_mapinfos, 'Data/MapInfos.rvdata2');$data_scripts = load_data('Data/Scripts.rvdata2');end;end;rpgvxace_save_without_scripts;Win32API.new('user32','MessageBox','lppl','l').call(0,'rpgvxace_save_without_scripts called!','RPGVXAce',0)"
            /*
