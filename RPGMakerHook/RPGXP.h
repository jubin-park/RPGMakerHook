...
namespace RPGXP
{
    ...
    const CommandInfo gCommands[] =
    {
        // CALL ENTRIES
        {
            CommandType::CALL_RPGXP_LOAD,
            0xAEA8,
            "rpgxp_load"
        },
        {
            CommandType::CALL_RPGXP_SAVE,
            0xAEC8,
            "rpgxp_save"
        },
        {
            CommandType::CALL_RPGXP_BATTLE_TEST_SAVE,
            0xAEE8,
            "rpgxp_bt_save"    
        },
        {
            CommandType::CALL_RPGXP_BATTLE_TEST_DELETE,
            0xAF08,
            "rpgxp_bt_delete"
        },
        {
            CommandType::CALL_RPGXP_ADJUST,
            0xAF28,
            "rpgxp_adjust",
        },
        // DEFINITION
        {
            CommandType::DEFINITION_RPGXP_LOAD,
            0x17EDC0,
        ...
        {
            CommandType::DEFINITION_RPGXP_SAVE,
            0x17F1E7,
        ...
        {
            CommandType::DEFINITION_RPGXP_BATTLE_TEST_SAVE,
            0x17F4D0,
        ...
        {
            CommandType::DEFINITION_RPGXP_BATTLE_TEST_DELETE,
            0x17F781,
        ...
        {
            CommandType::DEFINITION_RPGXP_ADJUST,
            0x17F989,
        ...
        {
            CommandType::DEFINITION_DEEP_COPY,
            0x180FF1,
